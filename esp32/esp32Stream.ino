...
#include <WiFi.h>
#include <ArduinoWebsockets.h> // Install the ArduinoWebsockets library
#include "esp_timer.h"
...
const char* ssid     = "cycnus"; // CHANGE HERE
const char* password = "14714714"; // CHANGE HERE

const char* websockets_server_host = "192.168.0.15"; //CHANGE HERE
